...
/** Admin prediction-history list item — same shape as the user-scoped one,
 *  plus nothing extra observed in `app/api/v1/admin/history.py`. */
export type AdminHistoryItem = PredictionHistoryItem;
