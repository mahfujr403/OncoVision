...
Runs migrations using the same async SQLAlchemy engine configuration and
`DATABASE_URL` as the running application (see `app.core.settings`), so
migrations never drift from the app's own database configuration.
"""
